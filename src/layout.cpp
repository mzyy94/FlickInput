...
void layout_jis_mac_kana_keybard()
{
  ...
  Keyboard.key_buttons[i++].set_action("小゛゜", layout_jis_mac_kana_mod_keybard);
  Keyboard.key_buttons[i++].set_keys("わ", KEYJISKANA_WA, KEYJISKANA_WO, KEYJISKANA_NN, KEYJISKANA_DASH);
  Keyboard.key_buttons[i++].set_keys("、。?!", KEYJISKANA_TOUTEN, KEYJISKANA_KUTEN, KEYJISKANAMAC_QUESTION, KEYJISKANAMAC_EXCL_MARK);
...
void layout_jis_mac_kana_mod_keybard()
{
  size_t i = 0;
  Keyboard.key_buttons[i++].set_repeatable_keys("→", KEY_RIGHT_ARROW);
  Keyboard.key_buttons[i++].set_action("ぁ", layout_jis_mac_kana_keybard, KEYJISKANA_XA, KEYJISKANA_XI, KEYJISKANA_XU, KEYJISKANA_XE, KEYJISKANA_XO);
  Keyboard.key_buttons[i++].set_action("が", layout_jis_mac_kana_keybard, KEYJISKANA_GA, KEYJISKANA_GI, KEYJISKANA_GU, KEYJISKANA_GE, KEYJISKANA_GO);
  Keyboard.key_buttons[i++].set_action("ざ", layout_jis_mac_kana_keybard, KEYJISKANA_ZA, KEYJISKANA_ZI, KEYJISKANA_ZU, KEYJISKANA_ZE, KEYJISKANA_ZO);
  Keyboard.key_buttons[i++].set_repeatable_keys("<x", KEY_DELETE);
  Keyboard.key_buttons[i++].set_repeatable_keys("←", KEY_LEFT_ARROW);
  Keyboard.key_buttons[i++].set_action("だ", layout_jis_mac_kana_keybard, KEYJISKANA_DA, KEYJISKANA_DI, KEYJISKANA_DU, KEYJISKANA_DE, KEYJISKANA_DO);
  Keyboard.key_buttons[i++].set_action("っ", layout_jis_mac_kana_keybard, KEYJISKANA_XTU);
  Keyboard.key_buttons[i++].set_action("ば", layout_jis_mac_kana_keybard, KEYJISKANA_BA, KEYJISKANA_BI, KEYJISKANA_BU, KEYJISKANA_BE, KEYJISKANA_BO);
  Keyboard.key_buttons[i++].set_repeatable_keys("空白", KEY_SPACEBAR);
  Keyboard.key_buttons[i++].set_action(layouts[next_layout]->icon, draw_next_keyboard, layouts[next_layout]->key);
  Keyboard.key_buttons[i++].set_action("ぱ", layout_jis_mac_kana_keybard, KEYJISKANA_PA, KEYJISKANA_PI, KEYJISKANA_PU, KEYJISKANA_PE, KEYJISKANA_PO);
  Keyboard.key_buttons[i++].set_action("ゃ", layout_jis_mac_kana_keybard, KEYJISKANA_XYA, KEYJISKANAMAC_LEFT_PAREN, KEYJISKANA_XYU, KEYJISKANAMAC_RIGHT_PAREN, KEYJISKANA_XYO);
  Keyboard.key_buttons[i++].set_keys("");
  Keyboard.key_buttons[i++].set_repeatable_keys("改行", KEY_ENTER);
  Keyboard.key_buttons[i++].set_keys("Esc", KEY_ESCAPE);
  Keyboard.key_buttons[i++].set_action("あいう", layout_jis_mac_kana_keybard);
  Keyboard.key_buttons[i++].set_keys("");
  Keyboard.key_buttons[i++].set_keys("@#$%", KEYJISKANAMAC_ATMARK, KEYJISKANAMAC_NUM_SIGN, KEYJISKANAMAC_DOLLAR, KEYJISKANAMAC_PERCENT);
...
void layout_us_mac_kana_keybard()
{
  ...
  Keyboard.key_buttons[i++].set_repeatable_keys("改行", KEY_ENTER);
  Keyboard.key_buttons[i++].set_keys("Esc", KEY_ESCAPE);
  Keyboard.key_buttons[i++].set_action("小゛゜", layout_us_mac_kana_mod_keybard);
...
void layout_us_mac_kana_mod_keybard()
{
  size_t i = 0;
  Keyboard.key_buttons[i++].set_repeatable_keys("→", KEY_RIGHT_ARROW);
  Keyboard.key_buttons[i++].set_action("ぁ", layout_us_mac_kana_keybard, KEYUSKANA_XA, KEYUSKANA_XI, KEYUSKANA_XU, KEYUSKANA_XE, KEYUSKANA_XO);
  Keyboard.key_buttons[i++].set_action("が", layout_us_mac_kana_keybard, KEYUSKANA_GA, KEYUSKANA_GI, KEYUSKANA_GU, KEYUSKANA_GE, KEYUSKANA_GO);
  Keyboard.key_buttons[i++].set_action("ざ", layout_us_mac_kana_keybard, KEYUSKANA_ZA, KEYUSKANA_ZI, KEYUSKANA_ZU, KEYUSKANA_ZE, KEYUSKANA_ZO);
  Keyboard.key_buttons[i++].set_repeatable_keys("<x", KEY_DELETE);
  Keyboard.key_buttons[i++].set_repeatable_keys("←", KEY_LEFT_ARROW);
  Keyboard.key_buttons[i++].set_action("だ", layout_us_mac_kana_keybard, KEYUSKANA_DA, KEYUSKANA_DI, KEYUSKANA_DU, KEYUSKANA_DE, KEYUSKANA_DO);
  Keyboard.key_buttons[i++].set_action("っ", layout_us_mac_kana_keybard, KEYUSKANA_XTU);
  Keyboard.key_buttons[i++].set_action("ば", layout_us_mac_kana_keybard, KEYUSKANA_BA, KEYUSKANA_BI, KEYUSKANA_BU, KEYUSKANA_BE, KEYUSKANA_BO);
  Keyboard.key_buttons[i++].set_repeatable_keys("空白", KEY_SPACEBAR);
  Keyboard.key_buttons[i++].set_action(layouts[next_layout]->icon, draw_next_keyboard, layouts[next_layout]->key);
  Keyboard.key_buttons[i++].set_action("ぱ", layout_us_mac_kana_keybard, KEYUSKANA_PA, KEYUSKANA_PI, KEYUSKANA_PU, KEYUSKANA_PE, KEYUSKANA_PO);
  Keyboard.key_buttons[i++].set_action("ゃ", layout_us_mac_kana_keybard, KEYUSKANA_XYA, KEYUSKANA_LEFT_PAREN, KEYUSKANA_XYU, KEYUSKANA_RIGHT_PAREN, KEYUSKANA_XYO);
  Keyboard.key_buttons[i++].set_keys("");
  Keyboard.key_buttons[i++].set_repeatable_keys("改行", KEY_ENTER);
  Keyboard.key_buttons[i++].set_keys("Esc", KEY_ESCAPE);
  Keyboard.key_buttons[i++].set_action("あいう", layout_us_mac_kana_keybard);
  Keyboard.key_buttons[i++].set_keys("");
...
void layout_jis_win_kana_keybard()
{
  ...
  Keyboard.key_buttons[i++].set_repeatable_keys("改行", KEY_ENTER);
  Keyboard.key_buttons[i++].set_keys("Esc", KEY_ESCAPE);
  Keyboard.key_buttons[i++].set_action("小゛゜", layout_jis_win_kana_mod_keybard);
  Keyboard.key_buttons[i++].set_keys("わ", KEYJISKANA_WA, KEYJISKANA_WO, KEYJISKANA_NN, KEYJISKANA_DASH);
  Keyboard.key_buttons[i++].set_keys("、。?!", KEYJISKANA_TOUTEN, KEYJISKANA_KUTEN, KEYJISKANAWIN_QUESTION, KEYJISKANAWIN_EXCL_MARK);
...
void layout_jis_win_kana_mod_keybard()
{
  size_t i = 0;
  Keyboard.key_buttons[i++].set_repeatable_keys("→", KEY_RIGHT_ARROW);
  Keyboard.key_buttons[i++].set_action("ぁ", layout_jis_win_kana_keybard, KEYJISKANA_XA, KEYJISKANA_XI, KEYJISKANA_XU, KEYJISKANA_XE, KEYJISKANA_XO);
  Keyboard.key_buttons[i++].set_action("が", layout_jis_win_kana_keybard, KEYJISKANA_GA, KEYJISKANA_GI, KEYJISKANA_GU, KEYJISKANA_GE, KEYJISKANA_GO);
  Keyboard.key_buttons[i++].set_action("ざ", layout_jis_win_kana_keybard, KEYJISKANA_ZA, KEYJISKANA_ZI, KEYJISKANA_ZU, KEYJISKANA_ZE, KEYJISKANA_ZO);
  Keyboard.key_buttons[i++].set_repeatable_keys("<x", KEY_DELETE);
  Keyboard.key_buttons[i++].set_repeatable_keys("←", KEY_LEFT_ARROW);
  Keyboard.key_buttons[i++].set_action("だ", layout_jis_win_kana_keybard, KEYJISKANA_DA, KEYJISKANA_DI, KEYJISKANA_DU, KEYJISKANA_DE, KEYJISKANA_DO);
  Keyboard.key_buttons[i++].set_action("っ", layout_jis_win_kana_keybard, KEYJISKANA_XTU);
  Keyboard.key_buttons[i++].set_action("ば", layout_jis_win_kana_keybard, KEYJISKANA_BA, KEYJISKANA_BI, KEYJISKANA_BU, KEYJISKANA_BE, KEYJISKANA_BO);
  Keyboard.key_buttons[i++].set_repeatable_keys("空白", KEY_SPACEBAR);
  Keyboard.key_buttons[i++].set_action(layouts[next_layout]->icon, draw_next_keyboard, layouts[next_layout]->key);
  Keyboard.key_buttons[i++].set_action("ぱ", layout_jis_win_kana_keybard, KEYJISKANA_PA, KEYJISKANA_PI, KEYJISKANA_PU, KEYJISKANA_PE, KEYJISKANA_PO);
  Keyboard.key_buttons[i++].set_action("ゃ", layout_jis_win_kana_keybard, KEYJISKANA_XYA, KEYJISKANAWIN_LEFT_PAREN, KEYJISKANA_XYU, KEYJISKANAWIN_RIGHT_PAREN, KEYJISKANA_XYO);
  Keyboard.key_buttons[i++].set_keys("");
  Keyboard.key_buttons[i++].set_repeatable_keys("改行", KEY_ENTER);
  Keyboard.key_buttons[i++].set_keys("Esc", KEY_ESCAPE);
  Keyboard.key_buttons[i++].set_action("あいう", layout_jis_win_kana_keybard);
  Keyboard.key_buttons[i++].set_keys("");
  Keyboard.key_buttons[i++].set_keys("@#$%", KEYJISKANAWIN_ATMARK, KEYJISKANAWIN_NUM_SIGN, KEYJISKANAWIN_DOLLAR, KEYJISKANAWIN_PERCENT);
...
void layout_us_alphabet_keybard()
{
  ...
  Keyboard.key_buttons[i++].set_repeatable_keys("改行", KEY_ENTER);
  Keyboard.key_buttons[i++].set_keys("Esc", KEY_ESCAPE);
  Keyboard.key_buttons[i++].set_action("a/A", layout_us_lower_alphabet_keybard);
...
void layout_us_lower_alphabet_keybard()
{
  ...
  Keyboard.key_buttons[i++].set_repeatable_keys("改行", KEY_ENTER);
  Keyboard.key_buttons[i++].set_keys("Esc", KEY_ESCAPE);
  Keyboard.key_buttons[i++].set_action("a/A", layout_us_alphabet_keybard);
  Keyboard.key_buttons[i++].set_keys("'\"()", KEY_US_SGL_QUOTE, KEY_US_DBL_QUOTE, KEY_US_LEFT_PAREN, KEY_US_RIGHT_PAREN);
  Keyboard.key_buttons[i++].set_keys(".,?!", KEY_US_DOT, KEY_US_COMMA, KEY_US_QUESTION, KEY_US_EXCL_MARK);
...
void layout_jis_alphabet_keybard()
{
  size_t i = 0;
  Keyboard.key_buttons[i++].set_repeatable_keys("→", KEY_RIGHT_ARROW);
  Keyboard.key_buttons[i++].set_keys("@#/&_", KEY_JIS_ATMARK, KEY_JIS_NUM_SIGN, KEY_JIS_FWD_SLASH, KEY_JIS_AMPERSAND, KEY_JIS_UNDERSCORE);
  Keyboard.key_buttons[i++].set_keys("ABC", KEY_A, KEY_B, KEY_C);
  Keyboard.key_buttons[i++].set_keys("DEF", KEY_D, KEY_E, KEY_F);
  Keyboard.key_buttons[i++].set_repeatable_keys("<x", KEY_DELETE);
  Keyboard.key_buttons[i++].set_repeatable_keys("←", KEY_LEFT_ARROW);
  ...
  Keyboard.key_buttons[i++].set_repeatable_keys("改行", KEY_ENTER);
  Keyboard.key_buttons[i++].set_keys("Esc", KEY_ESCAPE);
  Keyboard.key_buttons[i++].set_action("a/A", layout_jis_lower_alphabet_keybard);
  Keyboard.key_buttons[i++].set_keys("'\"()", KEY_JIS_SGL_QUOTE, KEY_JIS_DBL_QUOTE, KEY_JIS_LEFT_PAREN, KEY_JIS_RIGHT_PAREN);
  Keyboard.key_buttons[i++].set_keys(".,?!", KEY_US_DOT, KEY_US_COMMA, KEY_US_QUESTION, KEY_US_EXCL_MARK);
...
void layout_jis_lower_alphabet_keybard()
{
  ...
  Keyboard.key_buttons[i++].set_repeatable_keys("改行", KEY_ENTER);
  Keyboard.key_buttons[i++].set_keys("Esc", KEY_ESCAPE);
  Keyboard.key_buttons[i++].set_action("a/A", layout_jis_alphabet_keybard);
  Keyboard.key_buttons[i++].set_keys("'\"()", KEY_JIS_SGL_QUOTE, KEY_JIS_DBL_QUOTE, KEY_JIS_LEFT_PAREN, KEY_JIS_RIGHT_PAREN);
  Keyboard.key_buttons[i++].set_keys(".,?!", KEY_US_DOT, KEY_US_COMMA, KEY_US_QUESTION, KEY_US_EXCL_MARK);
