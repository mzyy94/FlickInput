...
void layout_jis_kana_keybard()
{
  ...
  Keyboard.key_buttons[i++].set_action("小゛゜", layout_jis_kana_mod_keybard);
...
void layout_jis_kana_mod_keybard()
{
  size_t i = 0;
  Keyboard.key_buttons[i++].set_repeatable_keys("→", KEY_RIGHT_ARROW);
  Keyboard.key_buttons[i++].set_action("ぁ", layout_jis_kana_keybard, KEYJISKANA_XA, KEYJISKANA_XI, KEYJISKANA_XU, KEYJISKANA_XE, KEYJISKANA_XO);
  Keyboard.key_buttons[i++].set_action("が", layout_jis_kana_keybard, KEYJISKANA_GA, KEYJISKANA_GI, KEYJISKANA_GU, KEYJISKANA_GE, KEYJISKANA_GO);
  Keyboard.key_buttons[i++].set_action("ざ", layout_jis_kana_keybard, KEYJISKANA_ZA, KEYJISKANA_ZI, KEYJISKANA_ZU, KEYJISKANA_ZE, KEYJISKANA_ZO);
  Keyboard.key_buttons[i++].set_repeatable_keys("<x", KEY_DELETE);
  Keyboard.key_buttons[i++].set_repeatable_keys("←", KEY_LEFT_ARROW);
  Keyboard.key_buttons[i++].set_action("だ", layout_jis_kana_keybard, KEYJISKANA_DA, KEYJISKANA_DI, KEYJISKANA_DU, KEYJISKANA_DE, KEYJISKANA_DO);
  ...
  Keyboard.key_buttons[i++].set_repeatable_keys("改行", KEY_ENTER);
  Keyboard.key_buttons[i++].set_keys("Esc", KEY_ESCAPE);
  Keyboard.key_buttons[i++].set_action("あいう", layout_jis_kana_keybard);
  Keyboard.key_buttons[i++].set_keys("");
...
void layout_us_kana_keybard()
{
  ...
  Keyboard.key_buttons[i++].set_repeatable_keys("改行", KEY_ENTER);
  Keyboard.key_buttons[i++].set_keys("Esc", KEY_ESCAPE);
  Keyboard.key_buttons[i++].set_action("小゛゜", layout_us_kana_mod_keybard);
...
void layout_us_kana_mod_keybard()
{
  size_t i = 0;
  Keyboard.key_buttons[i++].set_repeatable_keys("→", KEY_RIGHT_ARROW);
  Keyboard.key_buttons[i++].set_action("ぁ", layout_us_kana_keybard, KEYUSKANA_XA, KEYUSKANA_XI, KEYUSKANA_XU, KEYUSKANA_XE, KEYUSKANA_XO);
  Keyboard.key_buttons[i++].set_action("が", layout_us_kana_keybard, KEYUSKANA_GA, KEYUSKANA_GI, KEYUSKANA_GU, KEYUSKANA_GE, KEYUSKANA_GO);
  Keyboard.key_buttons[i++].set_action("ざ", layout_us_kana_keybard, KEYUSKANA_ZA, KEYUSKANA_ZI, KEYUSKANA_ZU, KEYUSKANA_ZE, KEYUSKANA_ZO);
  Keyboard.key_buttons[i++].set_repeatable_keys("<x", KEY_DELETE);
  Keyboard.key_buttons[i++].set_repeatable_keys("←", KEY_LEFT_ARROW);
  Keyboard.key_buttons[i++].set_action("だ", layout_us_kana_keybard, KEYUSKANA_DA, KEYUSKANA_DI, KEYUSKANA_DU, KEYUSKANA_DE, KEYUSKANA_DO);
  ...
  Keyboard.key_buttons[i++].set_repeatable_keys("改行", KEY_ENTER);
  Keyboard.key_buttons[i++].set_keys("Esc", KEY_ESCAPE);
  Keyboard.key_buttons[i++].set_action("あいう", layout_us_kana_keybard);
  Keyboard.key_buttons[i++].set_keys("");
